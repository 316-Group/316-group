...
export const ServicesHero: React.FC<Page['hero']> = ({
  links,
  media,
  includeStoreLinks,
  heroGraphic,
  ...
  return (
    <div className="text-slate-950">
      <div
        className={cn(
          'relative w-full h-full overflow-hidden z-[-2] pt-16 md:pt-28 overflow-hidden',
          bgColor,
        )}
      >
        {renderBackground()}
        ...
        <div className="relative container max-w-screen-2xl flex flex-col lg:flex-row gap-16 justify-between overflow-hidden pb-16 md:pb-28">
          <div className="sm:w-full md:max-w-[1/2] lg:max-w-[39%] z-[2] smb:px-3">
          ...
          <div className="sm:w-auto md:max-w-[1/2] lg:max-w-[61%] flex items-center content-center z-[3] mdb:px-3">
            {heroGraphic && typeof heroGraphic === 'object' && (
              <div className="">
                <Media
                  imgClassName="-z-10 object-fit inset-0 w-[150%] md:w-full h-full"
                  videoClassName="-z-10 absolute object-fit inset-0 w-[150%] md:w-full max-h-[100%]"
                  priority={false}
                  loading="lazy"
